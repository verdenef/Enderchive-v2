...
class UpdateGameRequest extends FormRequest
{
    ...
    {
        return true; // Allow all authenticated users to update games
    }
    ...
    {
        $gameId = $this->route('game')->game_id ?? null;
        
        return [
            'title' => 'sometimes|required|string|max:255|unique:games,title,' . $gameId . ',game_id',
